...
ds_chess = pascal_custom.pascal_voc(dir_name='chess_voc', cls_name='_classes.txt', is_training=True, use_diff=False)
ds_salad = pascal_custom.non_voc_txts(is_training=True, use_diff=False)
eval_ds_salad = pascal_custom.non_voc_txts(is_training=False, use_diff=False)
